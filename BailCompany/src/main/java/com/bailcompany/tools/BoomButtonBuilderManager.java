...
public class BoomButtonBuilderManager {
    ...
    private static BoomButtonBuilderManager ourInstance = new BoomButtonBuilderManager();

    private BoomButtonBuilderManager() {
    }
    ...
    public static BoomButtonBuilderManager getInstance() {
        return ourInstance;
    }
}